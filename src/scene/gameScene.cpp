...
GameScene::GameScene(Game* game)
    : Scene(game),
        ...
        cameraController(std::make_unique<CameraController>(GetScreenWidth(), GetScreenHeight()))
        
{
    ...
    gameEntities.emplace_back(std::make_shared<Entity>(
          attributes1, 100, tileMap, gameObjects));
}
